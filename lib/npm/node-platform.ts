...
const packageDarwin_arm64 = '@odenlang/darwin-arm64'
const packageDarwin_x64 = '@odenlang/darwin-x64'

export const knownWindowsPackages: Record<string, string> = {
  'win32 arm64 LE': '@odenlang/win32-arm64',
  'win32 ia32 LE': '@odenlang/win32-ia32',
  'win32 x64 LE': '@odenlang/win32-x64',
};

export const knownUnixlikePackages: Record<string, string> = {
  'android arm64 LE': '@odenlang/android-arm64',
  'darwin arm64 LE': '@odenlang/darwin-arm64',
  'darwin x64 LE': '@odenlang/darwin-x64',
  'freebsd arm64 LE': '@odenlang/freebsd-arm64',
  'freebsd x64 LE': '@odenlang/freebsd-x64',
  'linux arm LE': '@odenlang/linux-arm',
  'linux arm64 LE': '@odenlang/linux-arm64',
  'linux ia32 LE': '@odenlang/linux-ia32',
  'linux mips64el LE': '@odenlang/linux-mips64el',
  'linux ppc64 LE': '@odenlang/linux-ppc64',
  'linux riscv64 LE': '@odenlang/linux-riscv64',
  'linux s390x BE': '@odenlang/linux-s390x',
  'linux x64 LE': '@odenlang/linux-x64',
  'linux loong64 LE': '@odenlang/linux-loong64',
  'netbsd x64 LE': '@odenlang/netbsd-x64',
  'openbsd x64 LE': '@odenlang/openbsd-x64',
  'sunos x64 LE': '@odenlang/sunos-x64',
};

export const knownWebAssemblyFallbackPackages: Record<string, string> = {
  'android arm LE': '@odenlang/android-arm',
  'android x64 LE': '@odenlang/android-x64',
};
